...
let apiURL = "https://cstqkt-3001.csb.app/upload"; // Use the full backend URL
...
const VideoUpload: React.FC = () => {
  ...
  /**
   * While changing file input set it on state and show preview
   */
   ...
   * check max file size
   * check response receive from server
   * check internet connection
   * Show progress bar on uploading video to server
   */
